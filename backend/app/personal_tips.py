...
DESC_RECOVERY = {
    "เวท": "เวท น้ำหนักเบาถึงปานกลาง",
    "เดิน": "เดิน 30–45 นาที แบบพูดได้ไม่หอบ",
    "เครื่องเดิน": "เครื่องเดิน 20–30 นาที แบบเบาๆ",
    "ปั่นจักรยาน": "ปั่นจักรยานเบา 30–45 นาที",
    "มวย": "มวยแบบเทคนิคหรือชกเงา ไม่เต็มที่",
    "Functional Strength": "Functional ระดับเบา",
    "ปิงปอง": "ปิงปอง / เทนนิส เล่นเบาๆ ไม่แข่ง",
    "เทนนิส": "เทนนิส เล่นเบาๆ ไม่แข่ง",
    "ว่ายน้ำ": "ว่ายน้ำ 20–30 นาที แบบเรื่อยๆ",
    "HIIT": "HIIT แบบเบา — รอบสั้นๆ",
    "วิ่ง": "วิ่งเหยาะๆ 20–30 นาที",
    "โยคะ": "โยคะ หรือยืดเหยียด",
    "Core": "Core หรือฝึกความยืดหยุ่น",
    "อื่นๆ": "กิจกรรมเบาๆ",
}

DESC_PERFORMANCE = {
    "เวท": "เวท session หนัก ท่า compound หลัก",
    "เดิน": "เดินไกล / เดินยาว",
    "เครื่องเดิน": "เครื่องเดิน แบบรอบเข้ม-พัก",
    "ปั่นจักรยาน": "ปั่นยาว หรือปั่นรอบเข้ม",
    "มวย": "มวย session เต็ม",
    "Functional Strength": "Functional session เต็ม",
    "ปิงปอง": "ปิงปอง / เทนนิส เล่นแข่ง",
    "เทนนิส": "เทนนิส เล่นแข่ง",
    "ว่ายน้ำ": "ว่ายน้ำ รอบเข้ม",
    "HIIT": "HIIT / รอบเข้มหนัก",
    "วิ่ง": "วิ่งรอบเข้ม หรือ tempo run",
    "โยคะ": "โยคะ Flow แบบแอคทีฟ",
    "Core": "Core หรือ circuit เต็ม session",
    "อื่นๆ": "กิจกรรมเต็มศักยภาพ",
}
